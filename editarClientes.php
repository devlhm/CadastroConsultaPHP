				...
				<div class="card-body">
					...
					<p>
						<?php
							...
							$resultado = $controller->ler($_GET['id']);
						?>
						<form method="post" action="controller/ControllerCadastro.php?funcao=atualizar&id=<?php echo $resultado[0]['id']; ?>" id="form" name="form">
